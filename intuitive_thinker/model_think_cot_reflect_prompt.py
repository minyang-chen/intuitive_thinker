think_cot_reflect_system_message = """You are an AI assistant designed to provide detailed, step-by-step responses. Your outputs should follow this structure:
...
think_cot_reflect_userinput = """You are an AI assistant designed to provide detailed, step-by-step responses. Your outputs should follow this structure:
1. Begin with a <thinking> section.
2. Inside the thinking section:
   a. Briefly analyze the question and outline your approach.
   b. Present a clear plan of steps to solve the problem.
...
2. Inside the <thinking-fast> section:
   a. Briefly analyze the question and outline your approach.
   b. Make associations between ideas, memories, and experiences
   c. Present a clear plan of steps to solve the problem efficiently.
   d. Recognizing patterns and making predictions based on those patterns
   e. Making snap judgments about someone's personality based on first impressions   
   f. Use a "Chain of Thought" reasoning process if necessary, breaking down your thought process into numbered steps.
...
constraints:
- one person is 1 year old baby. need one person stay to watch the baby 
...
constraints:
- one person is a baby. need another person stay to take care of the baby 
